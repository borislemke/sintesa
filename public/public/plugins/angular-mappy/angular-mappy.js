                ...
                return {
                    ...
                    post: function (scope, element, attrs) {
                        ...
                        if (!scope.nullDataColor) {
                            scope.nullDataColor = "rgba(130,255,252,.3)";
                        ...
                        updateColors = function () {
                            ...
                            for (cc in _ref) {
                                ...
                                col = scope.nullDataColor || "rgba(130,255,252,.2)";
                                country.color = col;
                                country.hoverColor = "rgba(130,255,252,.5)";
                            ...
                            if (data) {
                                ...
                                for (cc in data) {
                                    ...
                                    if (scope.mapData.paths[cc]) {
                                        ...
                                        _results.push(scope.processedData[cc].hoverColor = lighten(col, 1.1) || "rgba(130,255,252,.5)");
                                    } else {
                        ...
                        if ((attrs.noScrollZoom != null)) {
                            svg.on("mousewheel", function (e, delta) {
                                ...
                                up = (e.originalEvent.wheelDelta || -e.originalEvent.detail) > 0 ? true : false;
                        ...
                        resize = function () {
                            return scope.elementWidth = element[0].width;
                        };
