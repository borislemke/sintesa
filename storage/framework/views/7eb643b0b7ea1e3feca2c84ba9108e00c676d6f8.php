        ...
        <div class="column width-10 push-1">
            <div class="row content-grid-3">
                ...
                <?php foreach($module->data as $item): ?>
                    <div class="grid-item<?php echo e(!$i ? ' grid-sizer' : ''); ?>">
                        <div class="thumbnail" data-hover-easing="easeInOut" data-hover-speed="500"
                            ...
                            <a href="<?php echo e($item->link->url); ?>"><img src="images/<?php echo e($item->image->src); ?>" width="500" height="400" alt="<?php echo e($item->image->alt); ?>"/>

                        </div>
                        <div class="team-content-info">
                            <h4 class="mb-20"><a href="<?php echo e($item->link->url); ?>"><?php echo e(translate($item->title)); ?></a></h4>
                            <p><?php echo e(translate($item->subtitle)); ?></p>
                        </div>
                    </div>
                    <?php $i++ ?>
                <?php endforeach; ?>
