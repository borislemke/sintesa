...
<script>
    ...
    function initMap() {
        map = new google.maps.Map(document.getElementById('jimbaran-map'), {
            center: {
                lat: <?php echo e($module->data->lat); ?>,
                lng: <?php echo e($module->data->long); ?>
            ...
            zoom: <?php echo e($module->data->zoom); ?>
        ...
        var locations = [],
            focus = [];
        locations = <?php echo json_encode($module->data->markers); ?>;
        focus = <?php echo json_encode($module->data->focus); ?>;
	...
	<div class="row collapse full-width">
		...
		<div class="column width-6 mobile-width-12">
			<table class="distances">
				<?php foreach($module->data->markers as $marker): ?>
				<tr>
					<td><strong class="color-gold"><?php echo e($marker->text); ?></strong></td>
					<td><?php echo e($marker->dist); ?></td>
					<td>a <?php echo e($marker->time); ?> drive</td>
				</tr>
				<?php endforeach; ?>
			</table>
		</div>
	...
	<div class="row">
		<div class="column width-10 offset-1">
			<div class="content-grid-3 masonry-grid equalize">
				...
				<?php foreach($module->data->markers as $marker): ?>
					<?php if ($i < 9) { ?>
						<div class="grid-item<?php echo e($i == 0 ? ' grid-sizer' : ''); ?> bkg-grey-ultralight" style="border:5px solid #fff;">
							<img src="<?php echo e($marker->image); ?>" />
							<div style="padding:20px;">
								<h4 class="mt-10"><?php echo e($marker->text); ?></h4>
								<?php echo translate($marker->description); ?>
