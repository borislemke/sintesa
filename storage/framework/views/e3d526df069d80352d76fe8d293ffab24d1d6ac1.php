...
<div class="section-block three-videos bkg-white">
    <div class="tmp-content">
        <div class="tmp-content-inner left">
            <?php /*<div class="row">*/ ?>
                <?php foreach($module->data as $video): ?>
                    ...
                    <div class="column width-4 center video-item">
                        <div class="video-item-background" style="background-image: url('/media/<?php echo e($video->background->src); ?>')">
                            <a href="<?php echo e($link); ?>"
                               ...
                               alt="<?php echo e($video->background->alt); ?>"></a>
                        </div>
                        <p class="mt-10"><?php echo e(translate($video->title)); ?></p>
                    </div>
                <?php endforeach; ?>
            <?php /*</div>*/ ?>
        </div>
