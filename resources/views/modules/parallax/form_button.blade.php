    ...
    <div class="enquiry-popup">
        ...
        <form class="reservation-form" id="enquire-form" method="post" novalidate>
           <div class="row small-margins">
                ...
                <div class="column width-4">
                    <input type="email" name="email" class="form-email form-element" placeholder="Email Address*" tabindex="3" required>
                </div>
                <div class="column width-4">
                    <input type="text" name="telephone" class="form-telephone form-element" placeholder="Telephone number" tabindex="4">
                </div>

                <div class="column width-4">
                    <input type="text" name="nationality" class="form-nationality form-element" placeholder="Nationality" tabindex="5">
                </div>
                <div class="column width-4">
                    <input type="text" name="country" class="form-country form-element" placeholder="Country" tabindex="5">
                </div>

                <div class="column width-12">
                    <input type="text" name="address" class="form-address form-element" placeholder="Address" tabindex="5">
                </div>
                <div class="column width-6">
                    <input type="text" name="city" class="form-city form-element" placeholder="City" tabindex="5">
                </div>
                <div class="column width-6">
                    <input type="text" name="province" class="form-province form-element" placeholder="Province" tabindex="5">
                </div>
                ...
                <div class="column width-6">
                    <input type="text" name="event" class="form-event form-element" placeholder="Event Name" tabindex="5">
                </div>
                <div class="column width-6">
                    <input type="text" name="company" class="form-company form-element" placeholder="Company" tabindex="5">
                </div>
                ...
                <div class="column width-4">
                    <input type="text" name="attendance" class="form-attendance form-element" placeholder="Number of Attendance" tabindex="1">
                </div>
                <div class="column width-4">
                    <input type="text" name="rooms" class="form-rooms form-element" placeholder="Number of Rooms" tabindex="2">
                </div>
                <div class="column width-4">
                ...
                <div class="column width-6">
                    ...
                    <input type="text" name="request-start" class="form-element" placeholder="Start Date" tabindex="1">
                    <input type="text" name="request-end" class="form-element" placeholder="End Date" tabindex="1">
                </div>
                <div class="column width-6">
                    <p class="mb-5">Alternate Date</p>
                    <input type="text" name="alternate-start" class="form-element" placeholder="Start Date" tabindex="1">
                    <input type="text" name="alternate-end" class="form-element" placeholder="End Date" tabindex="1">
                </div>
                <div class="clear"></div>
                <div class="sep"></div>
                <div class="column width-12">
                    <textarea name="message" class="form-message form-element" placeholder="Additional Information" tabindex="5"></textarea>
                    <div class="clear"></div>
                    <input type="submit" value="Send Email" class="form-submit  button  bkg-gold bkg-hover-black color-white color-hover-white">
                </div>
