@if(!isset($_COOKIE['hide_popup']))
    ...
    <div class="mt-module mt-module__plugins-popup active" id="popup-module">
        <div class="popup-module-window">
            <div class="popup-module-img-wrapper" style="background-image: url('http://sintesa.dev/media/page-banners/destination.jpg');"></div>
            <div class="popup-module-info-wrapper">
                ...
                <div class="module-popup-text-wrapper">
                    ...
                    <ol id="intro-list">
                        ...
                        <li>
                            After your request has been approved by the group admin(24 hours max), choose The Sintesa
                            Jimbaran for:
                        </li>
                    </ol>
                    <h3>Bali Leading Resort in Jimbaran</h3>

                    <a href="https://www.facebook.com/groups/668296123314831" target="_blank" class="button popup-module-button">JOIN FACEBOOK GROUP</a>
                </div>
            </div>
